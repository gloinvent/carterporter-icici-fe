...
@Component({
  selector: 'app-new-airport-transfer',
  templateUrl: './new-airport-transfer.component.html',
  styleUrls: ['./new-airport-transfer.component.scss'],
  providers: [LoginComponent],
})
export class NewAirportTransferComponent implements OnInit {
